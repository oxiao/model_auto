...
Model
 FtqyID string `gorm:"type:varchar(36);unique;unique_index;not null" json:"ftqy_id"` // f_id
 BfcID string `gorm:"type:varchar(36);unique;unique_index;not null" json:"bfc_id"` // 
